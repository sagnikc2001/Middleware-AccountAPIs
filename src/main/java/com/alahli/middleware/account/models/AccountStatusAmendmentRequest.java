...
public class AccountStatusAmendmentRequest {
	...
	public String toString() {
		return "AccountStatusAmendmentRequest [accountNumber=" + accountNumber + ", operationMode=" + operationMode
				+ ", override=" + override + ", overrideCode=" + overrideCode + ", currentStatus=" + currentStatus
				...
				+ ", lastAccountStatDate=" + lastAccountStatDate + ", fatcaFreeze=" + fatcaFreeze + ", workFlowFlag="
				+ workFlowFlag + "]";
	}
